...
public class MarchMadnessGUI extends Application {
    ...
    /**
     * Allows the user to return to the login screen after confirmation.
     *
     * @author Kevin Pinto
     */
    private void logout() {
    ...
    private boolean confirmNewBracket() {
        Alert alert = new Alert(AlertType.CONFIRMATION, "This will create a new BLANK bracket, are you sure?", ButtonType.YES, ButtonType.CANCEL);
    ...
    private void CreateToolBars() {
        ...
        toolBar.getItems().addAll(createSpacer(), login, simulate, logoutButton, scoreBoardButton, viewBracketButton, newBracketButton, createSpacer());
        ...
        btoolBar.getItems().addAll(createSpacer(), clearButton, resetButton,
                //Christian
                randomizeButton, finalizeButton, exitGameButton, infoButton, back = new Button("Choose Division"), createSpacer());
    ...
    private boolean confirmReset() {
        Alert alert = new Alert(AlertType.CONFIRMATION, "Are you sure you want to reset the ENTIRE bracket?", ButtonType.YES, ButtonType.CANCEL);
        alert.setTitle("March Madness Bracket Simulator");
        alert.setHeaderText(null);
        alert.showAndWait();
        return alert.getResult() == ButtonType.YES;
